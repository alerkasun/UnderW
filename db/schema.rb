...
ActiveRecord::Schema.define(version: 20150211131349) do
  ...
  add_index "certificates", ["default"], name: "index_certificates_on_default", using: :btree
  ...
  add_index "pendingcommands", ["device_id"], name: "index_pendingcommands_on_device_id", using: :btree
  ...
  add_index "uploaded_files", ["device_id"], name: "index_uploaded_files_on_device_id", using: :btree
